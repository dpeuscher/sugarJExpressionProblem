...
\title{Solution To The Expression Problem Using SugarJ}
\author{
\bfseries Author \\
...
\titlepic{
\centering
\scalebox{0.15}{\input{Uni_Marburg_Logo.pdf_tex}}
%\includegraphics[width=100px,keepaspectratio=true]{Siegel_Uni_Marburg.png}
}
...
\textsc{\LARGE Philipps Universit\"at Marburg}\\[1.5cm] % Name of your university/college
\textsc{\Large Fachbereich Mathematik Und Informatik}\\[0.5cm] % Major heading such as course name
\textsc{\large Thesis Submitted For The Degree Of \\\emph{Bachelor Of Science}}\\[0.5cm] % Minor heading such as course title
...
\hphantom{Tillmann \textsc{Rendel}, MSc.}
\end{flushleft}
\end{minipage}
~
\begin{minipage}[t][1.5cm][t]{0.4\textwidth}
...
\scalebox{0.15}{\input{Uni_Marburg_Logo.pdf_tex}}\\[2cm]
